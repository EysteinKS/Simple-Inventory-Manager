...
export default function useLodadedGate() {
  const authSelector = useSelector((state: RootState) => state.auth, shallowEqual)
  const prodSelector = useSelector((state: RootState) => state.products, shallowEqual)
  const catSelector = useSelector((state: RootState) => state.categories, shallowEqual)
  const ordSelector = useSelector((state: RootState) => state.orders, shallowEqual)
  const suppSelector = useSelector((state: RootState) => state.suppliers, shallowEqual)
  const saleSelector = useSelector((state: RootState) => state.sales, shallowEqual)
  const custSelector = useSelector((state: RootState) => state.customers, shallowEqual) 
